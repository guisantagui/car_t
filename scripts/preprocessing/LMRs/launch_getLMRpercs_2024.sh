...
#Define sdout path
#SBATCH --output=/home/users/gsantamaria/projects/car_t/scripts/preprocessing/output_launch_getLMRpercs_2024.txt
#Define sderr path
#SBATCH --error=/home/users/gsantamaria/projects/car_t/scripts/preprocessing/error_launch_getLMRpercs_2024.txt
...
minCov=5
outTag="2024"
outDir="/home/users/gsantamaria/projects/car_t/results/preprocessing/LMRs/2024/"
num_jobs=10
